...
export default function PageRouter() {
    ...
    const skins = ['f8dbbe70-0b77-44ab-8898-fe718ac81d50', 'da8a8993-adfa-4d29-99b1-9d0f62fbb78d', '35b74283-d9d4-4998-aa24-a9964c0f088e', '5c22897f-d31e-4aa4-9c97-a3ef0b5e0008', 'b876ec32-e396-476b-a115-8438d83c67d4', '069a79f4-44e9-4726-a5be-fca90e38aaf5', 'd9afca45-0bb2-4419-86aa-8ef9030eed55', '4232c61f-56db-4d4c-bdc2-4dbd406a3575', '094b0779-992c-4fac-90f5-fa839dc77dbc', '8667ba71-b85a-4004-af54-457a9734eed7'];
                                    ...
                                    <Suspense fallback={<></>}>
                                        ...
                                        >
                                            {({ data, isLoading }: { data: string; isLoading: boolean }) => {
                                                return isLoading ? <></> : <Gridtile skin={data} name={image.name}/>;
                                            }}
                                        </Async>
                                    </Suspense>
                                </div>
